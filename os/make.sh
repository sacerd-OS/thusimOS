...
OFILES="obj/kernel.o obj/puts.o obj/printf.o obj/putchar.o obj/strlen.o obj/terminal.o obj/boot.o obj/strcat.o"
...
$COMPILER -c $STRING/strcat.c -o obj/strcat.o $CFLAGS
